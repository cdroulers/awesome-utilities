...
namespace System.Web
{
    ...
    public class DataUriPostedFile : HttpPostedFileBase, IDisposable
    {
        ...
        public static DataUriPostedFile Parse(string dataUri)
        {
            ...
            int indexOfDataSeparator = dataUri.IndexOf(DataUriPostedFile.DataSeparator);
        ...
        public override int ContentLength { get { return this.contentLength; } }
        ...
        ///   
        /// <exception cref="T:System.NotImplementedException">Always.</exception>
        public override string ContentType { get { return this.contentType; } }
        ...
        ///   
        /// <exception cref="T:System.NotImplementedException">Always.</exception>
        public override Stream InputStream { get { return this.inputStream; } }
