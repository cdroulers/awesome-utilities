...
namespace System.Arithmetic
{
    ...
    /// </summary>
    public struct SingleArithmetic : IArithmetic<float>
    {
        ...
        /// <param name="y">The y.</param>
        /// <returns></returns>
        public bool GreaterThan(float x, float y)
        {
            return x > y;
        }
        ...
        /// <param name="y">The y.</param>
        /// <returns></returns>
        public bool GreaterOrEqualTo(float x, float y)
        {
            return x >= y;
        }
        ...
        /// <param name="y">The y.</param>
        /// <returns></returns>
        public bool LessThan(float x, float y)
        {
            return x < y;
        }
        ...
        /// <param name="y">The y.</param>
        /// <returns></returns>
        public bool LessOrEqualTo(float x, float y)
        {
            return x <= y;
        }
